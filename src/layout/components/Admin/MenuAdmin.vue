    ...
    <div class="nav-container primary-menu">
        ...
        <nav class="navbar navbar-expand-xl w-100 ">
            <ul class="navbar-nav justify-content-start flex-grow-1 gap-1">
                ...
                <li class="nav-item">
                    <router-link to="/admin/quan-li-san">
                        <a class="nav-link" href="/admin/quan-li-san">
                            <div class="parent-icon"><i class="fa-solid fa-futbol"></i>
                            </div>
                            <div class="menu-title text-nowrap">Quản Lý Sân Bóng</div>
                        </a>
                    </router-link>
                </li>
                <li class="nav-item">
                    <router-link to="/admin/khach-hang">
                        <a class="nav-link" href="/admin/khach-hang">
                            ...
                            <div class="menu-title text-nowrap">Quản Lý Khách Hàng</div>
                        </a>
                    </router-link>
                </li>
