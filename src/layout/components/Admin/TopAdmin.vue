        ...
        <div class="topbar d-flex align-items-center">
            <nav class="navbar navbar-expand">
                <div class="topbar-logo-header">
                    <div class="">
                        <img src="../../../assets/assets_Admin/images/logo_first.png" style="height: 65px;width: 75px;" class="logo-icon" alt="logo icon">
                    </div>
                    <div class="">
                        <h3 class="logo-text" style="color: purple">Admin</h3>
                    </div>
                </div>
                ...
                <div class="user-box dropdown">
                    <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        <img src="https://symbols.vn/wp-content/uploads/2021/12/Xem-them-hinh-dai-dien-avt-chibi-cho-con-trai.png"
