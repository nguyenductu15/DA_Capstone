<template>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2 ">
                            <a href="ecommerce-add-new-products.html" class="btn btn-primary mb-3 mb-lg-0"><i
                                    class="bx bxs-plus-square"></i>Danh Mục Sân</a>
                        </div>
                        <div class="col-lg-3 rounded-pill ">
                            <div class="input-group flex-nowrap ">
                                <span class="input-group-text rounded-pill" id="addon-wrapping"><i
                                        class="fa-solid fa-magnifying-glass"></i></span>
                                <input type="text" class="form-control rounded-pill " placeholder="Tìm kiếm sân"
                                    aria-label="Username" aria-describedby="addon-wrapping">
                            </div>
                        </div>
                        <div class="col-lg-2 ">
                            <select class="form-select form-select-sm rounded-pill" aria-label="Small select example">
                        ...
                        <div class="col-lg-2 ">
                            <select class="form-select form-select-sm  rounded-pill" aria-label="Small select example">
                                ...
                                <option value="1">350000</option>
                                <option value="2">400000</option>
                                <option value="3">500000</option>
                            </select>
                        </div>
                        <div class="col-lg-1 ">
                            <button class="btn btn-primary rounded-pill px-2">Tìm sân</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col mb-4">
            <div><img src="https://img.thegioithethao.vn/media/banner/2024/tgtt-052024-1.webp"
                    class="img-fluid rounded-5" style="height: 620px;width: 1290px;" alt="banner"></div>
        </div>

    </div>
    <div class="row mt-2  ">
        <div class="col product-grid">
            <div style="background-color:aqua; border-radius: 30px;" class="card">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="https://media.bongda.com.vn/files/hai.phan/2017/05/01/er8-1705.jpg"
                            style="border-radius: 30px;" alt="..." class="card-img">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h4 class="card-title mt-3">Có đầy đủ các thể loại <p class="text-center">cho các bạn lựa
                                    chọn!</p>
                            </h4>
                        </div>
                    </div>
        ...
        <div class="col product-grid">
            <div style="background-color:darkkhaki; border-radius: 30px;" class="card">
                <div class="row g-0">
                    <div class="col-md-4">
                        <img src="https://baodongnai.com.vn/file/e7837c02876411cd0187645a2551379f/dataimages/202009/original/images2312040_19b.jpg"
                            style="border-radius: 30px;" alt="..." class="card-img">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h4 class="card-title mt-3">Đặt sân nhanh <p>theo yêu cầu của bạn!</p>
                            </h4>
                        </div>
                    </div>
                </div>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-4 product-grid">
        ...
        <div class="col ">
            <div class="card m-3 border-4 border-danger " style="border-radius: 30px;">
                <img src="https://fpt123.net/uploads/images/san-co-nhan-tao/co-nhan-tao-11.jpg" class="card-img-top"
                    style="border-radius: 30px;" alt="...">

                <div class="card-body">
                    <h6 class="card-title cursor-pointer">Sân bóng Trương Vương</h6>
                    <h7 class="card-title cursor-pointer">Khu Vực: Cẩm Lệ</h7>
                    <h7 class="card-title cursor-pointer">
                        <p>Số sân: 7</p>
                    </h7>
                    <h5 class="card-title cursor-pointer mt-1">Giá : 500.000đ</h5>
        ...
        <div class="col ">
            <div class="card m-3 border-4 border-danger" style="border-radius: 30px;">
                <img src="https://images.toplist.vn/images/800px/san-bong-mini-chao-lua-896266.jpg" class="card-img-top"
                    style="border-radius: 30px;" alt="...">
        ...
        <div class="col ">
            <div class="card m-3 border-4 border-danger" style="border-radius: 30px;">
                <img src="https://co-nhan-tao.com/wp-content/uploads/2020/03/san-co-nhan-tao-1-1024x768.jpg"
                    class="card-img-top" style="border-radius: 30px;" alt="...">

                <div class="card-body">
                    <h6 class="card-title cursor-pointer">Sân bóng ĐH Bách Khoa</h6>
                    <h7 class="card-title cursor-pointer">Khu Vực: Liên Chiểu</h7>
                    <h7 class="card-title cursor-pointer">
                        <p>Số sân: 6</p>
                    </h7>
                    <h5 class="card-title cursor-pointer mt-1">Giá : 300.000đ</h5>
                    ...
                    <div class="d-flex align-items-center mt-3 fs-6">
                        ...
                        <p class="mb-0 ms-auto">5.0(195)</p>
                    </div>
                    <div class=" mt-2 text-center ">
                        <button class=" btn btn-info w-100 " style="border-radius: 20px;">Đặt ngay kẻo muộn</button>
                    </div>
        ...
        <div class="col">
            <div class="card m-3 border-4 border-danger" style="border-radius: 30px;">
                <img src="https://top10tphcm.com/wp-content/uploads/2020/12/san-bong-da-ca-sau-hoa-ca.jpg"
                    class="card-img-top" style="border-radius: 30px;" alt="...">

                <div class="card-body">
                    <h6 class="card-title cursor-pointer">Sân bóng Ông Bầu</h6>
                    <h7 class="card-title cursor-pointer">Khu Vực: Hòa Xuân</h7>
                    <h7 class="card-title cursor-pointer">
                        <p>Số sân: 8</p>
                    </h7>
                    <h5 class="card-title cursor-pointer mt-1">Giá : 450.000đ</h5>
                    ...
                    <div class="d-flex align-items-center mt-3 fs-6">
                        ...
                        <p class="mb-0 ms-auto">3.4(104)</p>
                    </div>
                    <div class=" mt-2 text-center ">
                        <button class=" btn btn-info w-100 " style="border-radius: 20px;">Đặt ngay kẻo muộn</button>
                    </div>
        ...
        <div class="col">
            <div class="card m-3 border-4 border-danger" style="border-radius: 30px;">
                <img src="https://lh3.googleusercontent.com/p/AF1QipOlQCgeEo9oIBTNlK7wTMaSSVh7anvpS2sg0Sz7=s680-w680-h510"
                    class="card-img-top" style="border-radius: 30px;" alt="...">

                <div class="card-body">
                    <h6 class="card-title cursor-pointer">Sân bóng Tiểu La</h6>
                    <h7 class="card-title cursor-pointer">Khu Vực: Hải Châu</h7>
                    <h7 class="card-title cursor-pointer">
                        <p>Số sân: 10</p>
                    </h7>
                    <h5 class="card-title cursor-pointer mt-1">Giá : 550.000đ</h5>
                    ...
                    <div class="d-flex align-items-center mt-3 fs-6">
                        ...
                        <p class="mb-0 ms-auto">4.7(220)</p>
                    </div>
                    <div class=" mt-2 text-center ">
                        <button class=" btn btn-info w-100 " style="border-radius: 20px;">Đặt ngay kẻo muộn</button>
                    </div>
    ...
    <div class="row">
        <div class="col">
            <div class="tab-office">
                <h3 class="title-office mt-4">Kết nối với SportBooking Shop</h3>
                <div class="tab-content-office">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_0" role="tabpanel" aria-labelledby="item_0_tab">
                            <div class="info-office">
                                <p>
                                    <i class="fa-solid fa-map-location-dot fa-xl"></i> Số 120, Hoàng Minh Thảo, Phường
                                    Hòa Khánh Nam, Quận Liên Chiểu, Thành phố Đà Nẵng
                                </p>
                                <p>
                                    <i class="fa-solid fa-phone fa-xl"></i> 0905.786.761
                                </p>
                                <p>
                                    <i class="fa-solid fa-envelope fa-xl"></i> nguyenductu150202@gmail.com
                                </p>
                                <p>
                                    <i class="fa-solid fa-mobile-screen-button fa-xl"></i> Hotline (Zalo): 0905667668
                                </p>
                            </div>
                        </div>
                    </div>
